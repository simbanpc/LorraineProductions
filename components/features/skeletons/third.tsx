...
export const SkeletonThree = () => {
  const partners = [
    { label: "Business", className: "top-4 left-7" },
    { label: "Community", className: "top-8 right-6" },
    { label: "Investment", className: "bottom-10 left-10" },
    { label: "Leadership", className: "bottom-6 right-10" },
  ];
  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center overflow-hidden">
      ...
      <div className="relative h-[260px] w-full max-w-[360px]">
        ...
        <svg className="absolute inset-0 z-10 h-full w-full" viewBox="0 0 360 260" fill="none">
          <path d="M180 130 L85 35" stroke="#C8A96A" strokeOpacity="0.45" strokeWidth="1.5" />
          <path d="M180 130 L275 55" stroke="#C8A96A" strokeOpacity="0.45" strokeWidth="1.5" />
          <path d="M180 130 L100 205" stroke="#C8A96A" strokeOpacity="0.45" strokeWidth="1.5" />
          <path d="M180 130 L270 210" stroke="#C8A96A" strokeOpacity="0.45" strokeWidth="1.5" />
        </svg>
